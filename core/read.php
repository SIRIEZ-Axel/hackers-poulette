...
<body class="m-0 ">
    <header class="flex items-center bg-teal-600 mb-16 h-24">
        <img src="../assets/img/hackers-poulette-logo.png" alt="hackers poulette logo" class="w-16">
        <h1 class="">
    ...
    <div class="flex justify-center shadow-sm">
        <div class="bg-teal-600 rounded-md ">
            <form action="read.php" method="GET" class="flex flex-col p-16 ">
            ...
            <label >Sujet :</label>
            <button data-dropdown-toggle="dropdown" class="text-teal-900 bg-white font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center type="button">Autre<svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
            ...
            <img class="flex"src="../assets/img/hackers-poulette-logo.png" alt="form img">
    </form>
</div>
</div>

<footer class="p-4 bg-teal-600 sm:p-6  mt-16">
